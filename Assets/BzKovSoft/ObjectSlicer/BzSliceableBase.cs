...
namespace BzKovSoft.ObjectSlicer
{
	...
	public abstract class BzSliceableBase : MonoBehaviour, IBzSliceable
	{
		...
		protected virtual void GetNewObjects(out GameObject resultObjNeg, out GameObject resultObjPos)
		{
			...
			resultObjNeg.GetComponent<Rigidbody>().constraints = RigidbodyConstraints.None;
			resultObjNeg.transform.parent = null;

			int lengthTrianglesNeg = resultObjNeg.GetComponent<MeshFilter>().mesh.triangles.Length;
			Debug.Log(lengthTrianglesNeg);
		}
